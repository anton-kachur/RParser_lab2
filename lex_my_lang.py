# Таблиця лексем мови
tableOfLanguageTokens = {'program': 'keyword', 'end': 'keyword', 'read': 'keyword', 'write': 'keyword', 'if': 'keyword',
                         'else': 'keyword', 'endif': 'keyword', 'for': 'keyword', 'then': 'keyword', 'int': 'keyword',
                         'bool': 'keyword', 'real': 'keyword', 'do': 'keyword', '=': 'assign_op', '.': 'dot', ' ': 'ws', '\t': 'ws',
                         '\n': 'nl', '-': 'add_op', '+': 'add_op', '*': 'mult_op', '/': 'mult_op', '(': 'brackets_op',
                         ')': 'brackets_op', '{': 'punct', '}': 'punct', ';': 'punct', 'is': 'rel_op', 'less': 'rel_op',
						 'more': 'rel_op', 'less_eq': 'rel_op', 'more_eq': 'rel_op', '^': 'pow_op'}
...
stf = {(0, 'Letter'): 1, (1, 'Letter'): 1, (1, 'Digit'): 1, (1, 'other'): 2, \
       ...
       (0, 'is'): 14, (0, 'less'): 14, (0, 'more'): 14, (0, 'less_eq'): 14, (0, 'more_eq'): 14, (0, ';'): 14,
       (0, '^'): 14, \
       (0, 'other'): 101
       }

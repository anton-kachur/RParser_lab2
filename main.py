...
def failParse(str,tuple):
    ...
    if str == 'getSymb(): неочікуваний кінець програми':
        ...
        elif lexeme == 'real' and token == 'keyword': return ''
        ...
        elif lex == 'int' and tok == 'keyword': return ''
        ...
        elif lex == 'real' and tok == 'keyword': return ''
        elif lex == 'bool' and tok == 'keyword': return ''
        else:
            print('Parser ERROR: \n\t В рядку {0} неочікуваний елемент ({1},{2}). \n\t Очікувався - {3}.'.format(numLine,lex,tok,expected))
            exit(3)
...
def parseStatement():
    ...
    # обробити iнструкцiю розгалуження
        ...
        parseIf()
        return True
    elif lex == 'more' or lex == 'less' or lex == 'less_eq' or lex == 'more_eq':
        return True
    elif (lex, tok) == ('in','keyword') or (lex, tok) == ('out','keyword'):
        parseStatement()
        return True
